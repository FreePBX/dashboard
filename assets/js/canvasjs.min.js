...
2;e.x2=this.chart._eventManager.objectMap[e.id].x2=e.textBlock.x+e.textBlock.width;e.y2=this.chart._eventManager.objectMap[e.id].y2=e.textBlock.y+e.textBlock.height-this.lineHeight/2}d+=v}0<k.length&&a.layoutManager.registerSpace(b,{width:this.width+2+2,height:this.height+5+5});this.bounds={x1:f,y1:c,x2:f+this.width,y2:c+this.height}};V(Da,M);Da.prototype.render=function(){var a=this.chart.layoutManager.getFreeSpace();this.ctx.fillStyle="red";this.ctx.fillRect(a.x1,a.y1,a.x2,a.y2)};V(aa,M);aa.prototype.getDefaultAxisPlacement=
...
new X(c[e].ctx,{text:c[e].title,horizontalAlign:"center",fontSize:c[e].titleFontSize,fontFamily:c[e].titleFontFamily,fontWeight:c[e].titleFontWeight,fontColor:c[e].titleFontColor,fontStyle:c[e].titleFontStyle,textBaseline:"top"}));if("normal"===f){var u=[],w=[],v=[],t=[],G=[],H=[],M=[],K=[];if(a&&0<a.length)for(e=0;e<a.length;e++)a[e]&&a[e].title&&(a[e]._titleTextBlock.maxWidth=a[e].titleMaxWidth||g.width,a[e]._titleTextBlock.maxHeight=a[e].titleWrap?0.8*g.height:1.5*a[e].titleFontSize,a[e]._titleTextBlock.angle=
...
d){qa[a]=d},formatNumber:function(a,d,b){b=b||"en";if(qa[b])return da(a,d||"#,##0.##",new pa(b));throw"Unknown Culture Name";},formatDate:function(a,d,b){b=b||"en";if(qa[b])return Fa(a,d||"DD MMM YYYY",new pa(b));throw"Unknown Culture Name";}};Pa.Chart.version="v1.9.6 GA";window.CanvasJS=Pa})();
/*
